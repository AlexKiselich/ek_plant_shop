...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference("Plant.count") do
      post plants_url, params: { plant: { difficulty: @plant.difficulty, name: @plant.name, type: @plant.type } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { difficulty: @plant.difficulty, name: @plant.name, type: @plant.type } }
